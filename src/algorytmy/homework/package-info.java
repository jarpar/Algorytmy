...
/*Zadania rekurencja:
    ...
    1. Załóżmy, że chcemy odwrócić w sposób rekurencyjny tablicę liczb całkowitych. Zaproponuj algorytm z użyciem rekurencji, który wykona to zadanie
    2. Powróćmy do problemu poszukiwania pewnej zadanej liczby x w tablicy, tym razem jednak posortowanej od wartości minimalnych do maksymalnych. Metoda poszukiwania, bardzo znana i efektywna (tzw. przeszukiwanie binarne), polega na poniższej obserwacji
Sprawdź środkowy element tablicy o rozmiarze n:
...
Zadanie polega na napisaniu rekurencyjnej funkcji realizującej powyższy algorytm
    3. Napisz funkcję potęgowania z użyciem rekurencji
    4. Napisz funkcję, która otrzymując liczbę całkowitą dodatnią, wypisze jej reprezentację dwójkową. Należy wykorzystać algorytm dzielenia przez podstawę systemu
